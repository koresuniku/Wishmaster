...
@Component (dependencies = [ApplicationComponent::class],
        modules = [(FullThreadBusinessLogicModule::class), (RxModule::class)] )
interface FullThreadBusinessLogicComponent {
    ...
    //Interactors
    fun fullThreadNetworkInteractor(): FullThreadMvpContract.IFullThreadNetworkInteractor
    fun fullThreadAdapterViewInteractor(): FullThreadMvpContract.IFullThreadAdapterViewInteractor
